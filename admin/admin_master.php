        ...
        <div class="container-fluid">
         ...
         <?php 
            if(isset($pages)){
                ...
                }else if($pages=='add_menufacture'){
                    include'./pages/add_menufacture_content.php';
                    
                }else if($pages=='manage_menufacture'){
                    include'./pages/manage_menufacture_content.php';
                    
                }else if($pages=='edit_manufacture'){
                    include'./pages/edit_menufacture_content.php';
